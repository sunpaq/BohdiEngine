...
{
    CVReturn result = [(__bridge BEWindow*)displayLinkContext getFrameForTime:outputTime];
    return result;
}
...
- (void) initGL
{
    ...
    renderer = [[BEWindowRenderer alloc] initWithFrame:viewRectPoints];
...
{	
    ...
    [renderer resizeAllScene:viewRectPixels.size];
